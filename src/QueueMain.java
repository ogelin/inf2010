...
public class QueueMain 
{
	...
	public static void main(String[] args) 
	{
		...
		for(int i = 0; i < COUNT*3.5; i++)
		{
			...
			{
				System.out.println("Erreur: l'ordre de sortie(FIFO) de la file n'est pas respecte.");
				return;
			}
		...
		{
			arrayQueue.pop();
			System.out.println("ArrayQueue Erreur: Pop doit lancer une exception lorsque la file est vide");
			return;
		} 
		catch (EmptyQueueException e){}
		...
		{
			listQueue.pop();
			System.out.println("listQueue Erreur: Pop doit lancer une exception lorsque la file est vide.");
			return;
		} 
		catch (EmptyQueueException e){}
